...
from momentumbot.research.sealed_historical_source_artifact_metadata_v08 import (  # noqa: E402
...
def main() -> int:
    ...
    try:
        receipt = load_and_validate_parent_artifact_metadata_v08(args.metadata_json)
