"""Register causal account valuation and generate synthetic evidence offline."""
import argparse
import json
import os
...
def main():
    ...
    from momentumbot.research import sealed_historical_account_valuation_v01 as producer
    ...
    if args.validate_registration:
        ...
        from tests.test_sealed_historical_account_valuation_v01 import synthetic_vectors
