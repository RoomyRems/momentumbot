...
def main():
    ...
    from momentumbot.research import sealed_historical_account_continuity_v01 as producer
    ...
    if args.validate_registration:
        ...
        from tests.test_sealed_historical_account_continuity_v01 import synthetic_vectors
