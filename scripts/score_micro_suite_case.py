...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Score only manifest-approved dimensions after a Micro runtime replay exists."
    )
    ...
    if runtime.get("frozen_policy_id") != suite.policy_id:
        raise ValueError("runtime policy does not match benchmark suite policy")
