"""Register account-state production and generate synthetic evidence offline."""
import argparse
import json
import os
...
def main():
    ...
    from momentumbot.research import sealed_historical_account_state_producer_v01 as producer
    ...
    if args.validate_registration:
        ...
        from tests.test_sealed_historical_account_state_producer_v01 import synthetic_vectors
        result = synthetic_vectors()
        args.output_root.mkdir(parents=True, exist_ok=False)
        raw = producer.fees.encoded(result)
