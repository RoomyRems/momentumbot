"""Provider-free final-freeze recovery runner for v0.11."""
...
from momentumbot.research.sealed_historical_source_acquisition_v11 import (
...
def build_safe_failure_v11(
    *,
    ...
    payload: dict[str, object] = {
        "schema_version": 1,
        "artifact_type": "sealed_historical_source_recovery_v0_11_safe_failure",
        "authorization": {
...
def main(argv: list[str] | None = None) -> int:
    ...
    if authorization.get("content_sha256") != AUTHORIZATION_CONTENT_SHA256:
        raise ValueError("v0.11 authorization constants disagree")
    ...
    if not output_is_outside_source_root(args.output, args.source_root):
        raise ValueError("v0.11 report must stay outside the source root")
    ...
    environment = validate_recovery_environment_pair_v11(
    ...
    report = build_recovery_report_v11(
        authorization_id=AUTHORIZATION_ID,
        authorization_content_sha256=AUTHORIZATION_CONTENT_SHA256,
