...
from momentumbot.research.micro_local_peak_ablation import MICRO_V0_2B_LOCAL_PEAK_ID
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Score the local-impulse-peak ablation after label-blind replay."
    )
    ...
    if runtime.get("ablation_id") != MICRO_V0_2B_LOCAL_PEAK_ID:
        raise ValueError("runtime is not the expected local-peak ablation")
    ...
    artifact = {
        "artifact_type": "micro_local_peak_ablation_suite_case_post_replay_score",
        "schema_version": 1,
        ...
        "peak_rule": runtime.get("peak_rule"),
        "peak_scope_bars": runtime.get("peak_scope_bars"),
