"""Build or revalidate the provider-free v0.5 pre-scanner checkpoint."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    authorization = load_authorization_envelope_v05(args.authorization)
    ...
    if args.validate_existing:
        ...
        return 0
    checkpoint = build_source_checkpoint_v05(
        source_root=args.source_root,
        authorization=authorization,
        recovery_receipt_path=args.parent_recovery_receipt,
        normalization_diagnostic_path=args.normalization_diagnostics,
