"""Single-fetch parent-artifact metadata gate for sealed recovery v0.10."""
...
ARTIFACT_ID = 9_827_444_933
ARTIFACT_NAME = (
    "sealed-historical-source-acquisition-v09-failure-checkpoint-33577895166-1"
)
ARTIFACT_DIGEST = (
    "sha256:0db44af6ffe695642444e384378faf3dfb3b6be8e059c0dca7bc0ee77d589244"
)
ARTIFACT_SIZE_BYTES = 44_337_250
PARENT_RUN_ID = 33_577_895_166
VALIDATOR_ID = "sealed-historical-parent-artifact-metadata-v0.10"
...
def validate_parent_artifact_metadata_v10(
    payload: Mapping[str, object],
) -> dict[str, object]:
    ...
    receipt: dict[str, object] = {
        "artifact_type": "sealed_historical_parent_artifact_metadata_v0_10_receipt",
...
def load_and_validate_parent_artifact_metadata_v10(
    path: str | Path,
) -> dict[str, object]:
    return validate_parent_artifact_metadata_v10(_load_metadata(path))
...
__all__ = [
    ...
    "load_and_validate_parent_artifact_metadata_v10",
    "validate_parent_artifact_metadata_v10",
]
