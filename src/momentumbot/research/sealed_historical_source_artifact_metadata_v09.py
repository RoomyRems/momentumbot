"""Single-fetch parent-artifact metadata gate for sealed recovery v0.9."""
...
VALIDATOR_ID = "sealed-historical-parent-artifact-metadata-v0.9"
...
def validate_parent_artifact_metadata_v09(
    payload: Mapping[str, object],
) -> dict[str, object]:
    ...
    receipt: dict[str, object] = {
        "artifact_type": "sealed_historical_parent_artifact_metadata_v0_9_receipt",
...
def load_and_validate_parent_artifact_metadata_v09(
    path: str | Path,
) -> dict[str, object]:
    return validate_parent_artifact_metadata_v09(_load_metadata(path))
...
__all__ = [
    ...
    "validate_parent_artifact_metadata_v09",
]
