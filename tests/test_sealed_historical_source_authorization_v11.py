...
from momentumbot.research import sealed_historical_source_authorization_v11 as authorization


ROOT = Path(__file__).resolve().parents[1]


class SealedHistoricalSourceAuthorizationV11Tests(unittest.TestCase):
    @classmethod
