...
from momentumbot.historical_float_identity_v08 import (
    ARTIFACT_ID,
    ...
    authoritative_float_identity_v08,
    canonical_fingerprint,
    validate_downstream_identity_preflight_receipt,
)
from scripts import build_causal_news_enrichment_v08 as news_adapter
from scripts import build_causal_scanner_snapshot_v08 as scanner_adapter
...
class DownstreamIdentityV08Tests(unittest.TestCase):
    def test_legacy_failure_is_reproduced_and_scope_restores_parent(self) -> None:
        ...
        with self.assertRaisesRegex(ValueError, "kind is unsupported"):
            original(candidate)
        with authoritative_float_identity_v08():
