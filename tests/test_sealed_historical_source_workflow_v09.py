...
WORKFLOW = ROOT / ".github/workflows/sealed-historical-source-acquisition-v09.yml"
...
class SealedHistoricalSourceWorkflowV09Tests(unittest.TestCase):
    @classmethod
    ...
    def test_parent_artifact_is_exact_and_recovery_precedes_provider_access(self) -> None:
        ...
        self.assertIn("validate_parent_artifact_metadata_v09.py", preflight_metadata)
        ...
        self.assertIn("validate_parent_artifact_metadata_v09.py", verify)
        ...
        self.assertIn("historical_source_recovery_v09", self.text)
    ...
    def test_no_massive_identity_market_sec_or_float_provider_stage_can_run(self) -> None:
        ...
        self.assertTrue(
            all("scripts/run_provider_entrypoint_v09.py" in run for run in provider_steps)
        )
        self.assertIn("build_causal_news_enrichment_v09.py", provider_steps[0])
        self.assertIn("build_causal_scanner_snapshot_v09.py", provider_steps[1])
    ...
    def test_checkpoint_is_uploaded_before_separate_provider_free_freeze(self) -> None:
        ...
        self.assertIn("build_causal_scanner_snapshot_v09.py", freeze_text)
        self.assertIn("run_sealed_historical_source_acquisition_v09.py", freeze_text)
    ...
    def test_action_revisions_and_environment_are_pinned(self) -> None:
        ...
        optimized = self._run(
            "validate", "Repeat v0.9 safety gates under optimized Python"
        )
