...
from momentumbot.research import sealed_historical_source_authorization_v07 as auth
from momentumbot.research.sealed_historical_source_checkpoint_v07 import (
    canonical_fingerprint,
)
from scripts.run_sealed_historical_source_acquisition_v07 import (
    _safe_budget,
...
class SealedHistoricalSourceAuthorizationV07Tests(unittest.TestCase):
    ...
    def test_consumption_marker_binds_exact_tag_target_and_attempt(self) -> None:
        ...
        marker = build_consumption_marker_v07(
