...
from scripts import build_causal_news_enrichment_v09 as news_adapter
from scripts import build_causal_scanner_snapshot_v09 as scanner_adapter
...
class DownstreamIdentityV09Tests(unittest.TestCase):
