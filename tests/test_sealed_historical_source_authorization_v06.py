...
from momentumbot.research import sealed_historical_source_authorization_v06 as auth
from momentumbot.research.sealed_historical_source_checkpoint_v06 import (
    canonical_fingerprint,
)
from scripts.run_sealed_historical_source_acquisition_v06 import (
    _safe_budget,
...
class SealedHistoricalSourceAuthorizationV06Tests(unittest.TestCase):
    ...
    def test_composite_budget_and_candidate_repair_do_not_change_strategy(self) -> None:
        ...
        self.assertEqual(budget["composite_parent_total_attempts"], 14_536)
        self.assertEqual(
        ...
        self.assertTrue(repair["all_946_recovered_candidates_preflighted_before_consumption"])
    ...
    def test_parent_failure_and_registration_bundles_validate_exact_files(self) -> None:
        ...
        self.assertEqual(
            parent["v0_5_failure_audit"]["content_sha256"],
    ...
    def test_consumption_marker_binds_exact_tag_target_and_attempt(self) -> None:
        ...
        marker = build_consumption_marker_v06(
