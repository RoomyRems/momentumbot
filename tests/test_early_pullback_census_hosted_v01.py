...
def approval():
    return {"approved_at": "2026-09-12T00:00:00Z", "expires_at": "2026-09-13T00:00:00Z",
        "approval_record_sha256": "d" * 64, "entitlement_record_sha256": "e" * 64,
        ...
        "incremental_cost_usd": "0.00", "subscription_changes_authorized": False}
...
class HostedCensusTests(unittest.TestCase):
    ...
    def prepare(self):
        ...
        self.artifact = {"id": 888, "name": "early-pullback-census-hosted-v01-consumption-123456-1",
    ...
    def test_missing_or_placeholder_approval_and_entitlement_rejected(self):
        for value in (None, {}, dict(approval(), approval_record_sha256="0" * 64),
                      dict(approval(), entitlement_record_sha256="0" * 64)):
    ...
    def test_cost_upgrade_date_route_and_entitlement_proof_changes_rejected(self):
        for key, value in (("incremental_cost_usd", "1.00"), ("subscription_changes_authorized", True),
    ...
    def test_cli_has_provider_free_registration_validation(self):
        result = subprocess.run([sys.executable, "scripts/run_early_pullback_census_hosted_v01.py", "--validate-only"],
    ...
    def test_workflow_actions_pinned_and_no_credential_checkout_persistence(self):
        ...
        script = (ROOT / "scripts/run_early_pullback_census_hosted_v01.py").read_text()
