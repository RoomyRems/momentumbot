...
from momentumbot.research import sealed_historical_source_acquisition_v08 as acquisition
...
def _build() -> dict[str, object]:
    with patch.object(
        ...
        return acquisition.build_acquisition_report_v08(
            authorization_id=checkpoint.AUTHORIZATION_ID,
            authorization_content_sha256=AUTHORIZATION_SHA,
...
class SealedHistoricalSourceAcquisitionV08Tests(unittest.TestCase):
    ...
    def test_report_rejects_checkpoint_tree_budget_and_recovery_mismatch(self) -> None:
        for field, value, pattern in (
            ...
            with patch.object(
                ...
                acquisition.build_acquisition_report_v08(**kwargs)
    ...
    def test_self_hash_and_causal_attestation_are_fail_closed(self) -> None:
        ...
        with patch.object(
            ...
            acquisition.validate_acquisition_report_v08(changed)
