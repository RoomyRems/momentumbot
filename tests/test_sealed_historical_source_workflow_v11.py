...
WORKFLOW = ROOT / ".github/workflows/sealed-historical-source-acquisition-v11.yml"
...
class SealedHistoricalSourceWorkflowV11Tests(unittest.TestCase):
    @classmethod
    ...
    def test_scanner_freeze_precedes_identity_compatible_final_replay(self) -> None:
        ...
        self.assertIn("run_sealed_historical_source_acquisition_v11.py", final)
