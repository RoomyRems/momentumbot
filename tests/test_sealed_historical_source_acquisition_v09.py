...
from momentumbot.research import sealed_historical_source_acquisition_v09 as acquisition
from momentumbot.research import sealed_historical_source_checkpoint_v09 as checkpoint
...
def _build() -> dict[str, object]:
    with patch.object(
        ...
        return acquisition.build_acquisition_report_v09(
            authorization_id=checkpoint.AUTHORIZATION_ID,
            authorization_content_sha256=AUTHORIZATION_SHA,
...
class SealedHistoricalSourceAcquisitionV09Tests(unittest.TestCase):
    ...
    def test_report_rejects_checkpoint_tree_budget_and_recovery_mismatch(self) -> None:
        for field, value, pattern in (
            ...
            with patch.object(
                ...
                acquisition.build_acquisition_report_v09(**kwargs)
    ...
    def test_self_hash_and_causal_attestation_are_fail_closed(self) -> None:
        ...
        with patch.object(
            ...
            acquisition.validate_acquisition_report_v09(changed)
