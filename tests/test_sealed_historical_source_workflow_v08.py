...
WORKFLOW = ROOT / ".github/workflows/sealed-historical-source-acquisition-v08.yml"
...
class SealedHistoricalSourceWorkflowV08Tests(unittest.TestCase):
    @classmethod
    ...
    def test_parent_artifact_is_exact_and_recovery_precedes_provider_access(self) -> None:
        self.assertEqual(
            self.text.count(
                'gh api "repos/${GITHUB_REPOSITORY}/actions/artifacts/9806541315"'
            ),
            2,
        )
        preflight = self._run(
        ...
        self.assertIn("validate_parent_artifact_metadata_v08.py", preflight_metadata)
        ...
        self.assertIn("actions/artifacts/9806541315", verify)
        self.assertIn("validate_parent_artifact_metadata_v08.py", verify)
        ...
        self.assertIn("historical_source_recovery_v08", self.text)
    ...
    def test_no_massive_identity_market_sec_or_float_provider_stage_can_run(self) -> None:
        ...
        self.assertTrue(
            all("scripts/run_provider_entrypoint_v08.py" in run for run in provider_steps)
        )
        self.assertIn("build_causal_news_enrichment_v08.py", provider_steps[0])
        self.assertIn("build_causal_scanner_snapshot_v08.py", provider_steps[1])
    ...
    def test_checkpoint_is_uploaded_before_separate_provider_free_freeze(self) -> None:
        ...
        self.assertIn("build_causal_scanner_snapshot_v08.py", freeze_text)
        self.assertIn("run_sealed_historical_source_acquisition_v08.py", freeze_text)
    ...
    def test_action_revisions_and_environment_are_pinned(self) -> None:
        ...
        optimized = self._run(
            "validate", "Repeat v0.8 safety gates under optimized Python"
        )
