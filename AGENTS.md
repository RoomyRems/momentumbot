...
| Sealed historical source recovery | `docs/research/sealed_historical_source_acquisition_v08.md` | permanent v0.7 pre-consumption metadata-gate failure, single-fetch artifact validation, exact retained-source recovery and Alpaca-only child boundary |
