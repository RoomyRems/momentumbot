...
| Sealed historical source recovery | `docs/research/sealed_historical_source_acquisition_v06.md` | permanent v0.5 identity-vocabulary failure, all-946 provider-free preflight, exact retained-source recovery and composite request boundary |
