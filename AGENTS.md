...
| Sealed historical source recovery | `docs/research/sealed_historical_source_acquisition_v07.md` | permanent v0.6 downstream-loader failure, all-946 candidate/float preflight, exact retained-source recovery and Alpaca-only child boundary |
