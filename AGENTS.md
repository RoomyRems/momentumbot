...
| Sealed historical provider availability | `docs/research/sealed_historical_provider_availability_v01_failure.md` | permanent v0.1 safe failure, sanitized report and credential-bound next gate |
