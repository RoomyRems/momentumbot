...
| Historical chronological account scheduling | `docs/research/sealed_historical_account_scheduler_v01.md` | one causal intraday clock, private entry outcomes, frozen scarcity and net-risk exits, preserved incomplete state and closed re-entry/carried-window/historical gates |
