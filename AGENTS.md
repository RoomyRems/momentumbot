...
| Sealed historical source recovery | `docs/research/sealed_historical_source_acquisition_v12.md` | permanent v0.10 identity-scope and v0.11 same-step interpreter failures, exact completed provider checkpoint, and provider-free v0.12 final-freeze boundary |
