...
| Sealed historical source recovery | `docs/research/sealed_historical_source_acquisition_v11.md` | permanent consumed v0.10 final-summarizer identity-scope failure, exact completed provider checkpoint, and provider-free final deep-replay child boundary |
