...
|---|---|---|
| Early-pullback authorized census and public pricing | `docs/research/early_pullback_census_hosted_v02.md` | truthful owner authorization, documented Basic-plan inference, unknown account entitlement, unchanged single-use capture and no paid fallback |
